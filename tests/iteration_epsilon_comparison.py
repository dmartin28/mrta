...
for test in range(num_tests):
    ...
    for epsilon in epsilons:
        ...
        total_reward, iteration_assignments, iteration_rewards, iteration_times = cluster_assignment_nn(model, robot_list, task_list, cluster_size, cluster_size, kappa, num_iterations, epsilon)
