...
"""HyperParameters"""
nu = 200 #number of robots # was 10
mu = 45 # number of tasks  # was 5
...
total_reward, iteration_assignments, iteration_rewards, iteration_times = cluster_assignment_rand(robot_list, task_list, num_iterations, hypes, printout=True)
